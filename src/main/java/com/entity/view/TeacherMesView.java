 ...
 */
@TableName("Teacher_Mes")
public class TeacherMesView extends TeacherMesEntity implements Serializable {
	...
	public TeacherMesView() {

	}

	public TeacherMesView(TeacherMesEntity TeacherMesEntity) {
		try {
			BeanUtils.copyProperties(this, TeacherMesEntity);
