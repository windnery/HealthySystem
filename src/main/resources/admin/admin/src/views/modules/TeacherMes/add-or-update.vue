        ...
        <el-form
            ...
            <input id="StudentId" name="StudentId" type="hidden">
                <el-col :span="24">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.TeacherLiuyanText" label="留言内容" prop="TeacherLiuyanText">
                            <span v-html="ruleForm.TeacherLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`TeacherLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.TeacherLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
